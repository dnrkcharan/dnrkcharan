  ...
  return (
    <section id="certifications" className="section-container">
      <div className="relative overflow-hidden rounded-[3rem] border border-charan-dark/10 bg-white/80 p-8 shadow-[0_28px_70px_rgba(5,1,10,0.1)] backdrop-blur-xl dark:border-white/10 dark:bg-gradient-to-br dark:from-white/5 dark:via-charan-dark/70 dark:to-charan-dark/90 lg:p-12">
        <div className="absolute -top-24 left-10 hidden h-48 w-48 rounded-full bg-charan-accent/20 blur-3xl dark:block" />
        <div className="absolute -bottom-28 right-8 hidden h-64 w-64 rounded-full bg-charan-primary/20 blur-3xl dark:block" />
        <div className="relative">
          <p className="text-xs uppercase tracking-[0.4em] text-charan-accent">Certifications</p>
          <h2 className="mt-3 text-3xl font-bold text-charan-dark dark:text-white">Certifications</h2>
          <p className="mt-3 max-w-3xl text-charan-dark/70 dark:text-white/70">
            ...
            {profile.certifications.map((cert, index) => (
              ...
              >
                <div className="relative h-48 overflow-hidden">
                  ...
                  <span className="absolute left-5 top-5 rounded-full bg-white/70 px-3 py-1 text-xs uppercase tracking-[0.3em] text-charan-dark/70 dark:bg-white/10 dark:text-white/80">
                    {`0${index + 1}`}
                  </span>
                </div>
                <div className="space-y-3 p-6">
                  <div>
                    <h3 className="text-xl font-semibold text-charan-dark dark:text-white">{cert.title}</h3>
                    <p className="text-sm text-charan-dark/60 dark:text-white/60">{cert.issuer}</p>
                  </div>
                  <p className="text-sm text-charan-dark/70 dark:text-white/75">{cert.description}</p>
