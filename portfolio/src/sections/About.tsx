...
export const About = () => {
  ...
  return (
    <section id="about" className="section-container">
      <div className="relative overflow-hidden rounded-[3rem] border border-[#c5ccff]/40 bg-gradient-to-br from-white via-[#dee3ff] to-[#c8cffc] p-8 shadow-[0_32px_90px_rgba(20,18,70,0.18)] backdrop-blur-2xl dark:border-white/10 dark:bg-gradient-to-br dark:from-white/5 dark:via-charan-dark/70 dark:to-charan-dark/90 lg:p-12">
        ...
        <div className="relative grid gap-12 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:items-start">
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              {profile.aboutStats.map((stat) => (
                <motion.div
                  key={stat.label}
                  whileHover={{ y: -6 }}
                  className="rounded-3xl border border-white/60 bg-gradient-to-br from-white via-[#eef0ff] to-[#dfe4ff] p-5 text-center shadow-[0_14px_36px_rgba(20,18,70,0.16)] dark:border-white/10 dark:bg-white/5"
                >
            ...
            <motion.div
              ...
              className="rounded-3xl border border-white/60 bg-gradient-to-br from-white via-[#eef0ff] to-[#dfe4ff] p-6 shadow-[0_16px_40px_rgba(20,18,70,0.16)] dark:border-white/10 dark:bg-white/5"
            >
          ...
          >
            <div className="rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-white via-[#e8ecff] to-[#d7defd] p-5 shadow-[0_18px_48px_rgba(18,16,70,0.16)] dark:border-white/10 dark:bg-white/5">
              <div className="grid grid-cols-1 gap-4 md:grid-cols-3">
                {profile.aboutHighlights.map((highlight, index) => (
                  <motion.div
                    ...
                    className="h-full rounded-3xl border border-white/70 bg-gradient-to-br from-white via-[#f1f3ff] to-[#e0e5ff] p-4 shadow-[0_12px_32px_rgba(18,16,70,0.14)] dark:border-white/10 dark:bg-white/5"
                  >
