...
export const Hero = () => {
  return (
    <section id="hero" className="section-container pt-28 lg:pt-36">
      <div className="relative overflow-hidden rounded-[3rem] border border-[#c1c8ff]/50 bg-gradient-to-br from-[#d9ddff] via-[#aab4ff] to-[#6e78ff] p-8 shadow-[0_34px_95px_rgba(18,16,70,0.2)] backdrop-blur-2xl dark:border-white/10 dark:bg-gradient-to-br dark:from-white/5 dark:via-charan-dark/70 dark:to-charan-dark/90 lg:p-12">
        ...
        <div className="relative grid gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-center">
          ...
          >
            <div className="relative w-full max-w-[420px] space-y-6">
              <div className="relative overflow-hidden rounded-[3rem] border border-white/60 bg-gradient-to-br from-[#dfe3ff] via-[#aeb8ff] to-[#7681ff] p-4 shadow-[0_28px_70px_rgba(18,16,70,0.18)] dark:border-white/15 dark:bg-charan-dark/60 dark:shadow-[0_25px_60px_rgba(5,1,10,0.45)]">
                <div className="rounded-[2.5rem] border border-white/60 bg-gradient-to-br from-[#e6eaff] via-[#b5c0ff] to-[#7e88ff] p-4 dark:border-white/10 dark:bg-gradient-to-br dark:from-white/5 dark:via-charan-dark/60 dark:to-charan-dark/80">
                  <div className="overflow-hidden rounded-[2rem] border border-white/60 bg-gradient-to-br from-[#e8ecff] via-[#b8c3ff] to-[#838dff] dark:border-white/10 dark:bg-charan-dark/70">
                    <img src={profile.photo.src} alt={profile.photo.alt} className="h-full w-full object-cover" />
                  </div>
                </div>
                <div className="mt-4 flex items-center justify-between rounded-2xl border border-white/60 bg-gradient-to-r from-[#e5e8ff] via-[#b3bdff] to-[#7e88ff] px-4 py-3 text-xs text-charan-dark/70 shadow-[0_12px_32px_rgba(18,16,70,0.14)] dark:border-white/10 dark:bg-white/5 dark:text-white/70">
              ...
              <div className="grid gap-4 sm:grid-cols-3">
                {profile.heroHighlights.map((highlight, index) => (
                  <motion.div
                    ...
                    className="rounded-2xl border border-white/60 bg-gradient-to-br from-[#e1e4ff] via-[#adb6ff] to-[#7681ff] p-4 text-left shadow-[0_16px_38px_rgba(18,16,70,0.14)] dark:border-white/10 dark:bg-charan-dark/60 dark:text-white"
                  >
